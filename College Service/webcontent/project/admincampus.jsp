    ...
    <div class="container">
        ...
        <table class="submission-table">
            ...
            try (Connection connection = DatabaseConnection.getConnection()) {
                ...
                String sql = "SELECT student_name, department, roll_no, phone, problems, image_path, date FROM campusform";
            ...
            %>
                <tr>
                    ...
                    <%
                        Blob imageBlob = resultSet.getBlob("image_path");
                        String image = null;
                        if (imageBlob != null) {
